...
export const PostImageBuildingApi = (token: any, hauseId: any, hauseImages: any[]) => {
...
export const PostInvoiceServiceFilesUploadApi = (token: any, id: any, invoiceImages: any[]) => {
...
export const PostImageUnitApi = (token: any, unitId: any, unitImages: any[]) => {
...
export const PostImageUserApi = (token: any, userId: any, userImages:any[]) => {
...
export const PostImageIdentityApi = (token: any, userId: any, identityImages: any[]) => {
  let formUser = new FormData();
...
export const PostImageContractApi = (token: any, contractId: any, ContractImages:any[]) => {
...
export const PostImageInvoiceApi = (token: string, invoiceId: string, invoiceImages: any[]) => {
  let formInvoice = new FormData();
  for (let i = 0; i < invoiceImages.length; i++) {
    let image = invoiceImages[i];
    formInvoice.append('files', {
